...
(async () => {
  ...
  try {
    ...
    const isRedo = (await page.locator('div.bg-orange-50.border-orange-200').count()) > 0;
    ...
    if (isRedo) {
      ...
      if (!redoFeedback) {
        throw new Error('Se detectó el banner de REDO pero no se pudo leer el feedback.');
      }
    }
