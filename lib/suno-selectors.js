...
module.exports = {
  ...
  // Suno renombró el aria-label del botón "⋯" de la card de "More options" a
  // "More from Suno" (drift detectado 2026-07-09 vía Antigravity, confirmado
  // con evidencia de DOM en vivo — ver LESSONS.md). Si vuelve a fallar el
  // click de Download, sospechar de este aria-label primero.
  MORE_OPTIONS_MENU_ARIA_SELECTOR: '[aria-label="More from Suno"]',
