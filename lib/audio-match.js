...
const SUNO_DIR = path.join(process.env.USERPROFILE || 'C:\\Users\\hecto', 'Downloads', 'suno');
...
module.exports = { findSunoMp3s, normalize, SUNO_DIR };
