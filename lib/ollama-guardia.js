...
const GUARDIA_RESPONSE_SCHEMA = {
  ...
  required: ['coherencia', 'rima', 'tono', 'fidelidad', 'gancho', 'confianza', 'estiloCoincide', 'problemas', 'veredicto', 'aprobada'],
};
...
function parseGuardiaResponse(raw) {
  ...
  const estiloCoincide = typeof data.estiloCoincide === 'boolean' ? data.estiloCoincide : null;
...
const AUDIO_GUARDIA_RESPONSE_SCHEMA = {
  ...
  required: ['coincideConLetra', 'similitud', 'nombreCorrecto', 'problemas', 'veredicto', 'aprobada', 'prioridadRevision'],
};
